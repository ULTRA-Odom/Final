...
class Board {
	...
	o.msg("\n\n You entered " + row.toUpperCase() +" " + column + "\n");
...
*****************/
	...
	else if ((row.equals("a")) && column <= 9) { a[column] = "M"; }
	else if ((row.equals("b")) && column <= 9) { b[column] = "M"; }
	else if ((row.equals("c")) && column <= 9) { c[column] = "M"; }
	else if ((row.equals("d")) && column <= 9) { d[column] = "M"; }
	else if ((row.equals("e")) && column <= 9) { e[column] = "M"; }
	else if ((row.equals("f")) && column <= 9) { f[column] = "M"; }
	else if ((row.equals("g")) && column <= 9) { g[column] = "M"; }
	else if ((row.equals("h")) && column <= 9) { h[column] = "M"; }
	else if ((row.equals("i")) && column <= 9) { i[column] = "M"; }
	else if ((row.equals("j")) && column <= 9) { j[column] = "M"111; }
	else {
...
public class Main {
  ...
  b.placeShip(columnStartRandom, rowRandom);
	...
	o.msg("But that's ok, I'll figure out how to move next time.");
